...
describe ApplicationHelper do
  ...
  it "should show the signin link" do
    ...
    helper.hydrus_signin_link.should == "<a href=\"/users/sign_in?referrer=%2Fitems%2Foo000oo0001\" class=\"signin_link\" data-url=\"/users/sign_in?referrer=%2Fitems%2Foo000oo0001\">Sign in</a>"
  end
