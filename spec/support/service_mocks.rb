...
module ServiceMocks
  ...
  def self.object_mocks(id)
    workflow(id)
    lifecycle(id)
    destroy_assembly_workflow(id)
    create_assembly_workflow(id)
    destroy_versioning_workflow(id)
  end
...
'                , :headers => {})
  ...
  def self.destroy_assembly_workflow(id)
  ...
  def self.create_assembly_workflow(id)
