...
h2. Deployment.
    ...
    # Commit your work, merge into develop|master, and push.
    # Make sure to modify CHANGELOG and VERSION as needed.
    ...
    # Deploy to dortest|production.
    DEPLOY_TO='dortest'
    kinit && aklog
    cd deploy && cap $DEPLOY_TO deploy && cd -
