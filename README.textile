...
e.g. RAILS_ENV=dortest rake hydrus:update_passwords['NEW_PASSWORD_HERE']
...
h3. Tests:
	...
	rake integration_test # just run rspec integration test with coverage report for only those tests (this will take a while)
